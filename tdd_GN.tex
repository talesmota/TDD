...
\subsection{xUnit}
  \begin{frame}
   Existem vários framework's para automatizar os testes de unidade. Os mais usados no mercado sem dúvida são os xUnit, abrangindo a quase todas linguagens.
   Para PHP temos:
   \begin{itemize}
    \item SimpleTest
    \pause
